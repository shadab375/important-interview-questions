...
public:
    ...
    void put(int key, int value) {
        ...
        else { //Time to remove LFU or LRU if tie when size == capacity
            
            auto &listt = freq.begin()->second;
            
            int key_delete = listt.back()[0]; //ordered_map ensures that the begin() will be th eleast frequency
